...
export type Field<T, Virtual extends string = never> = keyof WithSyncIdAndWithoutId<T> | Virtual;
...
export type Command<T> = RestCommand<T, BaseSchema>;
export type SingleRestCommand<T> = Command<T> | Promise<Command<T>>;
export type MultipleRestCommand<T> = Command<T> | [...Command<object>[], Command<T>] | Promise<Command<T> | [...Command<object>[], Command<T>]>;
