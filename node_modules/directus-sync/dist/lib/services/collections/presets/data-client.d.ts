...
export declare class PresetsDataClient extends DataClient<DirectusPreset> {
    ...
    protected getInsertCommand(item: WithoutIdAndSyncId<DirectusPreset>): import("@directus/sdk").RestCommand<{
    ...
    protected getQueryCommand(query: Query<DirectusPreset>): import("@directus/sdk").RestCommand<{
        [x: string]: never;
    }[], unknown>;
    protected getUpdateCommand(itemId: number, diffItem: Partial<WithoutIdAndSyncId<DirectusPreset>>): import("@directus/sdk").RestCommand<{
        filter: Record<string, any> | null;
        search: string | null;
        id: number;
        collection: string | null;
