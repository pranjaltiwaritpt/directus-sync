...
export declare class PresetsDataDiffer extends DataDiffer<DirectusPreset> {
    constructor(loggerService: LoggerService, dataLoader: PresetsDataLoader, dataClient: PresetsDataClient, dataMapper: PresetsDataMapper, idMapper: PresetsIdMapperClient);
}
