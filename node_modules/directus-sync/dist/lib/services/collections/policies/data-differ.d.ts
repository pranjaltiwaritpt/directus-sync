...
export declare class PoliciesDataDiffer extends DataDiffer<DirectusPolicy> {
    constructor(loggerService: LoggerService, dataLoader: PoliciesDataLoader, dataClient: PoliciesDataClient, dataMapper: PoliciesDataMapper, idMapper: PoliciesIdMapperClient);
}
