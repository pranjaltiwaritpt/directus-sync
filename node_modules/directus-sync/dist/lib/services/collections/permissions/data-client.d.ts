...
export declare class PermissionsDataClient extends DataClient<DirectusPermission> {
     ...
     */
    query<T extends object = DirectusPermission>(query: Query<DirectusPermission>): Promise<T[]>;
    protected getDeleteCommand(itemId: number): import("@directus/sdk").RestCommand<void, unknown>;
    protected getInsertCommand(item: WithoutIdAndSyncId<DirectusPermission>): Promise<[...Command<object>[], Command<DirectusPermission>] | import("@directus/sdk").RestCommand<{
    ...
    protected getQueryCommand(query: Query<DirectusPermission>): import("@directus/sdk").RestCommand<{
        [x: string]: never;
    }[], unknown>;
    protected getUpdateCommand(itemId: number, diffItem: Partial<WithoutIdAndSyncId<DirectusPermission>>): import("@directus/sdk").RestCommand<{
        permissions: Record<string, any> | null;
        presets: Record<string, any> | null;
        id: number;
        collection: string;
